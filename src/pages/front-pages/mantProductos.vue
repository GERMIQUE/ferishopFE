...
const isDialogVisibleActualizar = ref(false)
const isDialogVisibleMomento = ref(false)
...
async function ActualizarPedido() {
  ...
  console.log('pedidoId.value : ', pedidoId.value)
  console.log('nroPedido.value : ', nroPedido.value)


  isDialogVisibleMomento.value = false
  isDialogVisibleActualizar.value = true
...
async function addPedido() {
  isDialogVisibleMomento.value = true
  console.log("SelectedNropedido.value", SelectedNropedido.value)
  //console.log(SelectedNropedido.value)
...
watch(SelectedCli, async (newO,oldO) => {
  ...
  //console.log("newO.length = " , newO.toString.length)
  
   if(newO.toString.length > 0){
    //console.log("eNTRO!!!!!= " , newO)
     getNroPedido( newO )
...
<!---------------------------------------------------->
<VDialog
    v-model="isDialogVisibleActualizar"
    width="500"
  >
    ...
    <!-- Dialog close btn -->
    <DialogCloseBtn @click="isDialogVisibleActualizar = !isDialogVisibleActualizar" />

    <!-- Dialog Content -->
    <VCard title="Actualización de Pedido">
      <VCardText>
        Pedido Nro : {{ SelectedNropedido }} se ha actualizado con exito
      </VCardText>

      <VCardText class="d-flex justify-end">
        <VBtn @click="isDialogVisibleActualizar = false">
          Cerrar
        </VBtn>
      </VCardText>
    </VCard>
...
<!---------------------------------------------------->
<VDialog
    v-model="isDialogVisibleMomento"
    width="500"
  >
    ...
    <!-- Dialog close btn 
    <DialogCloseBtn @click="isDialogVisibleMomento = !isDialogVisibleMomento" />
-->
    <!-- Dialog Content -->
    <VCard title="Creación de Pedido">
      <VCardText>
