    ...
    >
      ...
      <div>
        <div class="d-flex flex-column gap-y-4 pa-4">
          <RouterLink
            v-for="(item, index) in ['Inicio', 'Ejes Estratégicos',   'Sobre Nosotros',   'Objetivo del Sitio', 'Catálogo de Servicio']"
            :key="index"
          ...
          <div class="font-weight-medium cursor-pointer">
            ...
            >
              Menu Sistema <VIcon :icon="isMenuOpen ? 'tabler-chevron-up' : 'tabler-chevron-down'" />
            </div>
      ...
      >
        ...
        <div class="d-flex align-center">
          ...
          <div class="text-base align-center d-none d-md-flex">
            <RouterLink              
               v-for="(item, index) in ['Inicio',   'Objetivo del Sitio', 'Ejes Estratégicos', 'Sobre Nosotros'   ]"
              :key="index"
              :to="{ name: 'front-pages-landing-page', hash: `#${item.toLowerCase().replace(' ', '-')}` }"
               class=" font-weight-medium py-2 px-2 px-lg-4"
              :class="[props.activeId?.toLocaleLowerCase().replace('-', ' ') === item.toLocaleLowerCase() ? 'active-link' : '']"
            >
            <!--nav-link-->
              {{ item }}  
            </RouterLink>
            <div class=" font-weight-medium py-2 px-2 px-lg-4  active-link"  ><a href="checkout">Catálogo de Servicios</a></div>
            <!-- Pages Menu 
            <span
        ...
        <div class="d-flex gap-x-4">
          <!-- se quita icono para entra al sistema   <NavbarThemeSwitcher /> -->


          <!-- boton para comprar producto, se desactivo
          <VBtn
