...
import avatar2 from '@images/avatars/avatar-1.png'
import avatar3 from '@images/avatars/avatar-1.png'
...
const reviewData = [
  {
    desc: '"Establecer la innovación y la transformación como pilares estratégicos en EFE mediante el aprovechamiento de la tecnología”',
    img: logo1,
    rating: 5,
    name: 'Propósito',
    position: 'Para qué',
  ...
  {
    desc: '"Desempeñar un papel fundamental como socio estratégico de la organización, liderando la adopción de tecnologías innovadoras que se alineen con los objetivos del negocio. Nuestro compromiso es garantizar la continuidad de los servicios tecnológicos con un enfoque en la eficiencia, calidad, disciplina y gestión de riesgos.”',
    img: logo2,
    rating: 5,
    name: 'Misión',
    position: 'Cómo lo hacemos',
    avatar: avatar2,
  },
  {
    desc: '“Ser líderes en tecnología disruptiva a través de investigación y desarrollo (I+D), priorizando la innovación, agilidad, disciplina y efectividad en todas las áreas de la organización”',
    img: logo3,
    rating: 4,
    name: 'Visión',
    position: 'Qué queremos conseguir', 
    avatar: avatar3,
  },
    /*
  {
...
<template>
  <VContainer id="nuestros-valores" > 
  <div
    id="customer-review"
          ...
          >
            ...
            <!--
              ...
              <p class="text-body-1 mb-12">
                Pilares en los cuales son nuestras bases para el exito tecnologíco e innovación.
              </p>
              <!--
