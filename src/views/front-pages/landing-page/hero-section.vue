        ...
        <VContainer>
          <div  class="checkout-card"> 
            ...
            <h1 class="hero-title mb-4">
             Catálogo de Sistemas  de Gerencia de Tecnología y Soluciones Digitales
            </h1>
            <h6 class="mb-6 text-h6">
              Herramienta que transformará la forma en que gestionamos nuestros sistemas internos: Nuestro nuevo catálogo de sistemas EFE
            </h6>
            -->
